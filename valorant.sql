...
CREATE TABLE `armas` (
  ...
  `escopetas` varchar(50) NOT NULL,
  `submetralhadoras` varchar(50) NOT NULL,
  `rifles` varchar(50) NOT NULL,

)

--
--estraindo dados da tabela `armas`
--

INSERT INTO `armas` (`id`, `Pistolas`, `escopetas`, `submetralhadoras`, `rifles`) VALUES
(1, 'classic','bucky', 'stinger', 'guardian'),
(2, 'shorty', 'judge', 'sprectre', 'bulldog'),
(3, 'frenzy', '','','phantom' ),
(4, 'ghost','','','vandal') ,
(5,'sheriff', '','','')
--
